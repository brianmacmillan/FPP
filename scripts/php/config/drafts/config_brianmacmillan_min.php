<?php
	...
	$HEADER2='<html xmlns="http://www.w3.org/1999/xhtml"><head>';
	...
	*/
	...
	$FOOTER='</html>';
	$ICON='<link rel="shortcut icon" href="images/favicons/starburst.ico" type="image/x-icon">';
	$CSS_MAIN='<link href="css/bm_main-min.css" rel="stylesheet" type="text/css" media="screen">';
	...
	$CSS_TABS='<link href="css/tab.css" rel="stylesheet" type="text/css" media="screen">';
	...
	$JS_BM_MAIN='<script type="text/javascript" src="js/min/jquery.bm_main-min.js"></script>';
	$JS_BM_LOGS='<script type="textt/javascript" src="js/min/jquery.bm_logs-min.js"></script>';
	$JS_BM_USERS='<script type="text/javascript" src="js/min/jquery.bm_users-min.js"></script>';
	$JS_BM_UTILS='<script type="text/javascript" src="js/min/bm_utilities-min.js"></script>';
	$JS_BM_COMMENTS='<script type="text/javascript" src="js/min/jquery.bm_comments-min.js"></script>';
	$JS_BM_STORIES='<script type="text/javascript" src="js/min/bm_stories-min.js"></script>';
	$JS_BM_DATABASE='<script type="text/javascript" src="js/min/bm_database-min.js"></script>';
	$JS_BM_USER_INTERFACE='<script type="text/javascript" src="js/min/jquery.bm_user_interface-min.js"></script>';
	$JS_BM_PRODUCTS='<script type="text/javascript" src="js/min/jquery.bm_products-min.js"></script>';
	$JS_BM_DOCUMENTS='<script type="text/javascript" src="js/min/jquery.bm_documents-min.js"></script>';
	
	$JS_BROWSER_DETECTION='<script type="text/javascript" src="js/min/browser_detection-min.js"></script>';
	
	$JS_BM_POEMS='<script type="text/javascript" src="js/min/bm_poems-min.js"></script>';
	$JS_SERIAL_SCROLL_INIT_POEMS='<script type="text/javascript" src="js/serial_scroll_init_poems.js"></script>';
	$JS_JQUERY_BM_POEMS='<script type="text/javascript" src="js/min/jquery.bm_poems-min.js"></script>';
	...
	*/
	...
	$JS_SCROLL_TO='<script type="text/javascript" src="js/jquery.scroll_to-min.js"></script>';
