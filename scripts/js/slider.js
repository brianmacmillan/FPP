...
$(function() {
    ...
    $('#slider-me-add-year').click(function(){
      ...
      var iTemp = $("#slider-me").uislider('option','value');
      var iMax = $("#slider-me").uislider('option','max');
      if (iTemp+1 == iMax){
        iTemp=$("#slider-me").uislider('option','min');  
        iTemp++; /* move to second year for display purposes */
      } else {
        iTemp++;
      }
      $("#slider-me").uislider('value', iTemp);
    });
    ...
    $( "#slider-me" ).uislider({
        ...
        change: function( event, ui ) {
            var sResult="";
            var iYear = $("#slider-me").uislider("option", "value");
            var iMax =  $("#slider-me").uislider("option", "max");
            var iMin =  $("#slider-me").uislider("option", "min");

            if (iYear==iMax) iYear=iMin+1;
            $("#slider-me-description").text("");

            if (iYear>1973 && iYear < 1993){
              $("#slider-me").uislider('value', 1993);
              return;  
            }
            if (iYear>1993 && iYear < 1996){
              $("#slider-me").uislider('value', 1996);
              return;  
            }
            if (iYear==1997){
              $("#slider-me").uislider('value', 1998);
              return;  
            }
            if (iYear>2001 && iYear < 2003){
              $("#slider-me").uislider('value', 2003);
              return;  
            }
